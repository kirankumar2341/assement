...
class FileHandler:
    def __init__(self, bucket_name, endpoint_url=None,table_name=None, aws_access_key_id= "test", aws_secret_access_key= "test", region_name='us-east-1'):
    ...
    def download(self, query_params):
        ...
        try:
            ...
            return {
                "statusCode": 200,
                "body": json.dumps({"downloadUrl": pre_signed_url,"metada":metadata_str})
            }
        except Exception as e:
            return {
                "statusCode": 500,
